...
HD_PWD='E:/Electronics/Verilog Projects/RISC-V_Pipelined_Core/RISC-V Pipelined Core.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pipeline_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pipeline_top.tcl -notrace
