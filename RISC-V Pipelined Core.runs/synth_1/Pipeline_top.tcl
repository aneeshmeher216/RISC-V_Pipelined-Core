...
synth_design -top Pipeline_top -part xc7a200tffg1156-2
...
generate_parallel_reports -reports { "report_utilization -file Pipeline_top_utilization_synth.rpt -pb Pipeline_top_utilization_synth.pb"  } 
